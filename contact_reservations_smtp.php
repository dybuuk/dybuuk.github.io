...
if($_POST)
{
    $to_Email       = "3com@wp.pl"; // Replace with recipient email address
	$subject        = 'Wiadomość z 3COM '.$_SERVER['SERVER_NAME']; //Subject line for emails
    
    $host           = "smtp.wp.pl"; // Your SMTP server. For example, smtp.mail.yahoo.com
    $username       = "3com@wp.pl"; //For example, your.email@yahoo.com
    $password       = "2Klaudiusz"; // Your password
